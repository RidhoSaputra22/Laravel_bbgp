@extends('layouts.app', ['title' => 'Review Hasil Assessment'])
            ...
            <div class="section-body">
                @if (session('message') === 'update')
                    <div class="alert alert-success">
                        Penilaian manual berhasil disimpan dan ringkasan skor sudah diperbarui.
                    </div>
                @endif

                @if ($errors->any())
                    <div class="alert alert-danger">
                        <div class="font-weight-bold mb-2">Periksa kembali input penilaian berikut:</div>
                        <ul class="mb-0 pl-3">
                                            ...
                                            <div class="border rounded p-3 mb-4">
                                                ...
                                                @foreach ($form['fields'] ?? [] as $field)
                                                    @php
                                                        ...
                                                        $manualReviewField = $manualReviewFields[$fieldId] ?? null;
                                                    ...
                                                    <div class="card shadow-none border mb-3">
                                                        <div class="card-body">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-4">
                                                                            <div class="form-group">
                                                                                <label>Skor Assessor (1-5)</label>
                                                                                <select name="scores[{{ $fieldId }}]"
                                                                                    class="form-control @error('scores.' . $fieldId) is-invalid @enderror">
                                                                                    <option value="">Belum dinilai</option>
                                                                                    @foreach (\App\Enum\LevelKompetensi::options() as $value => $label)
                                                                                        <option value="{{ $value }}"
                                                                                            @selected(old('scores.' . $fieldId, $answer['assessor_score'] ?? null) == $value)>
                                                                                            {{ $label }}
                                                                                        </option>
                                                                                    @endforeach
                                                                                </select>
                                                                                @error('scores.' . $fieldId)
                                                                        ...
                                                                        <div class="col-md-8">
                                                                            <div class="form-group">
                                                                                <label>Catatan Assessor</label>
                                                                                <textarea name="notes[{{ $fieldId }}]" class="form-control @error('notes.' . $fieldId) is-invalid @enderror"
                                                                                    rows="3" placeholder="Catatan tambahan untuk jawaban ini">{{ old('notes.' . $fieldId, $answer['assessor_notes'] ?? '') }}</textarea>
                                                                                @error('notes.' . $fieldId)
                                                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                                                @enderror
                                                                            </div>
                                                            ...
                                                            @elseif (!empty($answer['assessor_score_label']))
                                                                <div class="mt-3">
                                                                    <span class="badge badge-success">
                                                                        Dinilai assessor: {{ $answer['assessor_score_label'] }}
                                                                    </span>
                                                                </div>
                                                            @endif
                                                        </div>
